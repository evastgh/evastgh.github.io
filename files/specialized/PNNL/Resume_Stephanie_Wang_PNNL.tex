...
\section{Positions}
\subsection{Research}
\cventry{2020-present}{Postdoc -- with Prof. \href{https://cseweb.ucsd.edu/~alchern/}{Albert Chern}}{UCSD}{}{San Diego, CA}{Geometry processing, geometric deep learning, and physical simulation using mathematical insights from geometric measure theory, exterior calculus, partial differential equations, and optimization theory. Developing in Houdini and Python. Mentored PhD students: 
...
\cvline{}{
    {Fluid Cohomology}. 
    Hang Yin, Mohammad Sina Nabizadeh, Baichuan Wu, \underline{Stephanie Wang}, and Albert Chern. SIGGRAPH 2023 (accepted.)
}
\cvline{}{
