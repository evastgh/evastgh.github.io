...
\section{Experience}
\subsection{Research}
\cventry{2020-present}{Postdoc -- with Prof. \href{https://cseweb.ucsd.edu/~alchern/}{Albert Chern}}{UCSD}{}{San Diego, CA}{Geometric deep learning, geometry optimization and physics-based simulation of various materials (deformable body, fluid, wave, \textit{etc.}). Developing and prototyping using Houdini and Python.
...
{Studying of snow and tire interaction using physics-based simulation, in collaboration with Michelin tires.}
