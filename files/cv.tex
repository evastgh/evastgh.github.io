...
{}
\cventry{Jun 2016}{M.S. in Mathematics}{UCLA}{}{} 
...
\cventry{2019 spring}{Principal Instructor}{UCLA Math Dept}{}{Los Angeles, CA}
{Teaching Math 33A -- Linear Algebra and Applications.}
...
\cventry{2017-2020}{Creator}{Women in Math Mentorship Program, UCLA}{}{}{Secure fundings, coordinate regular mixers for undergraduate and graduate fellows to increase connection, awareness and mentorship.}
...
\section{Skills}
\cvline{Languages}{English -- full proficiency; Mandarin Chinese -- native}
\cvline{Programming}{C++, lua, MATLAB, vim, bash, zsh, \LaTeX}
\cvline{Tools}{Houdini, HDK, git, gdb, valgrind, Eigen, tbb, CVX}
\cvline{Mathematics}{Extensive coursework in differential equations, optimization theory, numerical methods, and numerical linear algebra.}
