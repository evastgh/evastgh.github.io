...
\vspace*{-2mm}
\section{A Short Research Statement}
\cvline{}{
    ...
    In addition to my 5-year experience in developing and maintaining C++ code, I also have 4 years of experience using Houdini to implement prototypes and research projects. Developing in Houdini gives short turn-around time (3-5x faster than using C++) and easy visualization during early stages of a research project. 
}
