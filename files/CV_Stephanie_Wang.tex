...
\section{Experience}
\subsection{Research}
\cventry{2020-present}{Postdoc -- with Prof. \href{https://cseweb.ucsd.edu/~alchern/}{Albert Chern}}{UCSD}{}{San Diego, CA}{Geometry processing and physical simulation using mathematical insights from geometric measure theory, exterior calculus, partial differential equations, and optimization theory. Mentored students: 
    \href{https://sinabiz.github.io/}{Mohammad Sina Nabizadeh} (3rd year CSE PhD student),
    \href{https://www.linkedin.com/in/shiyang-jia-a4aa6b174}{Shiyang Jia} (2nd year CSE PhD student),
    \href{https://chadmckell.com/}{Chad McKell} (4th year Computer Music PhD student).
}
...
\vspace*{-2mm}
\section{Skills}
\cvline{Programming}{C++ (Eigen, tbb), lua, MATLAB (CVX), \LaTeX, shell scripts}
